...
<head>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-MW36T3RES7"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-MW36T3RES7');
</script>
  <meta charset="utf-8" />
  ...
  <link rel="shortcut icon" href="<?= base_url ?>/assets/img/logo/logo-team.png" />
  <!-- Global site tag (gtag.js) - Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-9GLNT44VCT"></script>
 ...
 <!--  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script> -->
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script><!-- desfgloce de menu -->
...
<!--   
  <nav class="navbar navbar-expand-lg navbar-light fixed-top text-white" id="" style="background-color: #000000;">
      <div class="container" id="cont-cero">
        ...
        <div class="respon-menu collapse navbar-collapse" id="navbarResponsive">
